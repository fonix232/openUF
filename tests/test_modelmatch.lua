-- Tests for openuf/modelmatch.lua against the generated catalogue.
-- Run from project root: lua tests/run_tests.lua

local match   = dofile("openuf/modelmatch.lua")
local catalog = dofile("openuf/ufmodel/catalog.lua")
