 ...
 *   --password PW     root password           (openuf-test, as run.sh sets)
...
const opts = { base: 'http://127.0.0.1:8080', password: 'openuf-test', out: 'shots', schemes: 'light,dark', viewport: '1440x900' };
const routes = [];
