#!/bin/sh
#
# Install luci-theme-unifi onto an OpenWrt device without a buildroot.
#
...
set -e
tar -o -C / -xf -
sh /etc/uci-defaults/30_luci-theme-unifi && rm -f /etc/uci-defaults/30_luci-theme-unifi
rm -f /tmp/luci-indexcache.*
rm -rf /tmp/luci-modulecache/
/etc/init.d/rpcd reload 2>/dev/null || true
echo "luci-theme-unifi installed; theme: $(uci -q get luci.main.mediaurlbase)"
'
