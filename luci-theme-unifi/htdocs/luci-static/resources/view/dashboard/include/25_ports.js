...
'require baseclass';
'require ui';
'require view.unifi.ports as ports';

/*
 * luci-mod-dashboard widgets from luci-theme-unifi: the router's ports as
...
return baseclass.extend({
	...
	available() {
		if (!/\/luci-static\/unifi(-dark|-light)?\/?$/.test(L.env.media || ''))
			return false;
