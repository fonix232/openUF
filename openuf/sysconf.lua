--[[
	...
	conf.lua `controller_system` gates each part: true (default) applies all
	three, false none, or a table {timezone=, ntp=, cron=} picks. A site with a
...
-- `gate` is conf.lua's controller_system (see the header).
