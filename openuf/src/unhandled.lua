--[[
	...
	Why: a controller sent an AP a `cmd` it had never sent before --
	`mesh-halt`, the first device-facing mesh verb seen -- and all that
	survived of it was one logread line naming the verb. The unknown-cmd path
	logged the name and dropped the body, and nothing was capturing at the
	time. (Ported from the yesrab/openUF fork, where that happened.)
	amd989/unifi-gateway keeps such a file
...
-- life of the process (option unhandled_file 'off').
